...
namespace Wed_Project.Migrations
{
    ...
    [Migration("20260507135428_PremiumSubscriptionAndTokenQuota")]
    partial class PremiumSubscriptionAndTokenQuota
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web_Project.Models.User", b =>
                {
                    ...
                    b.ToTable("Users", t =>
                        {
                            t.HasCheckConstraint("CK_Users_SubscriptionTier", "[SubscriptionTier] IN (N'Normal', N'Premium')");
                        });
                });
